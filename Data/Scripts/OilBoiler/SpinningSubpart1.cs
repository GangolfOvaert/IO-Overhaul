...
namespace OilBoilerSpinAnimation1
{
    // Edit the block type and subtypes to match your block.
    [MyEntityComponentDescriptor(typeof(MyObjectBuilder_OxygenGenerator), false, "OilBoiler")]
    public class OilBoilerSpin1 : MyGameLogicComponent
    {
        ...
        public override void UpdateOnceBeforeFrame()
        {
            ...
            MatrixZ = Matrix.CreateRotationZ(-0.025f);
        ...
        public override void UpdateBeforeSimulation()
        {
            try
            {
                bool shouldSpin = block.IsWorking;
                ...
                if(Entity.TryGetSubpart(SUBPART_NAME, out subpart))
                {
                    ...
                    if(shouldSpin)
					{		
						var offset = new Vector3(4.17346f, -1.675f, -1.73732f); // (x, y, z) offset from center of block
