...
namespace OilBoilerSpinAnimation2
{
    ...
    public class OilBoilerSpin2 : MyGameLogicComponent
    {
        ...
        public override void UpdateBeforeSimulation()
        {
            try
            {
                ...
                if(Entity.TryGetSubpart(SUBPART_NAME, out subpart))
                {
                    ...
                    if(shouldSpin)
					{		
						var offset = new Vector3(4.8313f, -1.675f, -1.73732f); // (x, y, z) offset from center of block
