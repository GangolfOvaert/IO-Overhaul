...
namespace T2MaterialRefinerySpinAnimation2
{
    // Edit the block type and subtypes to match your block.
    [MyEntityComponentDescriptor(typeof(MyObjectBuilder_Refinery), false, "T2MaterialRefinery")]
    public class T2MaterialRefinerySpin2 : MyGameLogicComponent
    {
